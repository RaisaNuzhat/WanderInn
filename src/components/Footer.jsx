...
const Footer = () => {
    return (
        <div className="mb-0">
            <footer className="footer  footer-center p-10 bg-[#233142] text-primary-content">
                <aside>
                    ...
                    <p className="font-bold lg:text-3xl text-[20px]">
                        WanderInn  Ltd. <br />Providing reliable services since 1992
                    </p>
